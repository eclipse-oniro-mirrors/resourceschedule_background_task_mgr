...
#ifndef FOUNDATION_RESOURCESCHEDULE_BACKGROUNDTASKMANAGER_FRAMEWORKS_COMMON_INCLUDE_BGTASKMGR_LOG_WRAPPER_H
#define FOUNDATION_RESOURCESCHEDULE_BACKGROUNDTASKMANAGER_FRAMEWORKS_COMMON_INCLUDE_BGTASKMGR_LOG_WRAPPER_H
